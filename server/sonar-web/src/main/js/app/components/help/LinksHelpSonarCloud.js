  ...
  return (
    <div>
      ...
      <p className="spacer-bottom">
        <a href="https://www.codescan.io/tos/">{translate('footer.terms')}</a>
      </p>
      ...
      <p className="spacer-bottom">
        <a href="https://www.codescan.io/help/support/">{translate('footer.help')}</a>
      </p>
      ...
      <p>
        <a href="https://www.codescan.io/cloud/getting-started/">{translate('footer.about')}</a>
      </p>
    </div>
  );
}

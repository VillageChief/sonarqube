...
import org.sonar.application.process.EsConnector;
import org.sonar.application.process.EsConnectorImpl;
...
public class EsStartupOnlyProcessMonitor implements ProcessMonitor {
	...
	public EsStartupOnlyProcessMonitor(Props props) {
		this.esConnector = new EsConnectorImpl();
		this.props = props;
	}
